...
import { answeredBy, answeredLabel, chosenOption, settledQuestions, waitingQuestions } from "./commandQueue.ts";
...
test("answered questions are listed newest first with what was chosen", () => {
  const snapshot = parseSnapshot({ healthy: true, questions: [
    question("a", "billing", "2026-09-24T00:10:00Z", "answered", { answer_id: "x", answer: "A", answer_kind: "option" }),
...
test("a closed question says what was chosen, by whom and when", () => {
  ...
  const snapshot = parseSnapshot({ healthy: true, questions: [
    question("by-you", "billing", "2026-09-24T00:10:00Z", "answered", { answer_id: "x", answer: "B", answer_kind: "option", answered_option: "B", answered_by: "overlord", answered_at: at }),
    question("by-cfo", "", "2026-09-24T00:20:00Z", "answered", { answer_id: "y", answer: "Ship it Friday", answer_kind: "other", answered_option: "", answered_by: "cfo", answered_at: at }),
    question("older", "notes", "2026-09-24T00:30:00Z", "answered", { answer_id: "z", answer: "A", answer_kind: "option" }),
  ] });
  ...
  const cases: [typeof byYou, string, string, string][] = [
    ...
    [byCfo, "", "The CFO wrote: Ship it Friday", "Answered by the CFO"],
