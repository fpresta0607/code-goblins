...
func cleanupSnapshot(panes, agents string) string {
	return `{"result":{"type":"session_snapshot","snapshot":{"protocol":19,"workspaces":[{"workspace_id":"ws","label":"firstmate"}],"tabs":[{"tab_id":"tab-g1","workspace_id":"ws","label":"fm-g1"}],"panes":[` + panes + `],"agents":[` + agents + `]}}}`
}
