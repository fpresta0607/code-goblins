...
func TestRenderersProjectOneTypedSnapshot(t *testing.T) {
		...
		Tasks: []TaskRow{
			{
				...
				Path:     `C:\work\active`,
				Actions:  Actions{Peek: "cfo peek gb-active"},
			},
			{
				ID:      "stale",
				...
				Kind:    "scout",
				Backend: "herdr",
				Actions: Actions{Peek: "cfo peek gb-stale"},
			},
			{
				ID:      "unknown",
				...
				Actions: Actions{Peek: "cfo peek gb-unknown"},
			},
		},
		Backlog: BacklogRows{
			Queued: []BacklogRow{
	...
	for _, want := range []string{
		...
		"| active | working / endpoint | active | - | 2026-08-13T12:00:00Z | 0 | no | ship | C:\\project | herdr | fleet:pane-active (present) | C:\\fleet\\data\\active\\report.md | C:\\work\\active | cfo peek gb-active |",
		"| stale | done / status | stale | 12s | 2026-08-13T12:00:00Z | 2 | yes | scout | - | herdr | unknown | - | - | cfo peek gb-stale |",
		"| unknown | unknown / none | unknown | - | - | 0 | no | - | - | - | unknown | - | - | cfo peek gb-unknown |",
