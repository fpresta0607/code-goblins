...
#
# AWAY MODE. While state/.afk exists this script arms nothing and remains alive.
# It parks without watcher ownership until the flag clears, then re-arms from the
# same tracked process. The away-mode daemon
