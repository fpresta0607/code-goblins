...
The arm layer and every automatic primary adapter stand down for the duration so the daemon keeps the watcher singleton and those one-shot wakes never reach the primary pane; [`watcher-continuity.md`](watcher-continuity.md) "Away-mode stand-down" owns that contract.
