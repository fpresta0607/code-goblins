...
The arm layer gates new arm calls, while Pi and OpenCode also suppress automatic re-arm and delivery for cycles already live at away-mode entry; [`watcher-continuity.md`](watcher-continuity.md) "Away-mode stand-down" owns that contract and its cross-harness boundary.
