...
The task-local launch claim identifies managed native worktrees without requiring `sqlite3` on an unmanaged invocation's `PATH`, while a missing or revoked claimed contract fails closed.
