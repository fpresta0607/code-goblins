...
2. Honor any explicit Supreme Overlord instruction that sets a floor for that candidate before the generic comparison.
...
6. Resolve remaining uncertainty explicitly.
   ...
   Prefer known viable evidence when otherwise comparable, and report uncertainty or ask the Supreme Overlord when it still prevents a justified choice.
...
9. Genuine ties: stop and report every tied candidate for Supreme Overlord choice.
