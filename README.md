...
A tab left open across an install notices the newer board: a hidden tab reloads itself, and one on screen shows one line, **The board was updated**, with **Reload**, so it never reloads while you answer.
