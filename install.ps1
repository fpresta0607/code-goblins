# install.ps1 - build or download the code-goblins CFO binary (cfo.exe),
...
$tools = @(
    ...
    @{ Name = "chrome-devtools-axi"; Kind = "npm";        Cmd = "npm install -g chrome-devtools-axi@0.1.34" },
    @{ Name = "chrome-devtools-mcp"; Kind = "npm";        Cmd = "npm install -g chrome-devtools-mcp@1.9.0" },
    @{ Name = "lavish-axi";          Kind = "npm";        Cmd = "npm install -g lavish-axi" }
)
