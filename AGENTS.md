...
config/herdr-child-workspaces  default-off Herdr space-per-crewmate grouping flag; LOCAL, gitignored; inherited by secondmate homes; see docs/configuration.md and docs/herdr-backend.md
