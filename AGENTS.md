...
state/               volatile runtime signals; gitignored
  ...
  <id>.meta          task metadata written by fm-spawn; its script header and help own the exact base fields and mutation contract; docs/configuration.md owns trace-context and runtime-backend interpretation; fm-pr-check and fm-x-link own the fields they append
